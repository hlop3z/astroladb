...
export interface MigrationDefinition {
  /**
   * Unique revision identifier for this migration.
   * Auto-generated by `alab new` using timestamp format (e.g. "20260201_143022").
   */
  up_revision?: string;

  /**
   * Revision identifier of the parent migration, forming the revision chain.
   * `null` for the first migration in the chain.
   */
