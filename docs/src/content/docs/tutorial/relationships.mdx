...
This continues from [Your First Project](/tutorial/first-project/). We'll add
...
<Aside type="tip">
Next: [Generating Code](/tutorial/generating-code/) — we'll export types and
run a generator to produce a working API from this schema.
</Aside>
